#!/bin/bash
#
# Script pushToProd1Servererver.sh
# Prep CAR code for transport to the Production 1 server.
...
#   - begins an sftp connection to the Production 1 server
