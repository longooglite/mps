...
manage_evals = {
	...
	"containers": [],
	"statusMsg": "",
	"successMsg":"Manage Evaluations Complete",
	...
	"config": {
		...
		"emailTemplateName": "engin_umich_promotion_acad_eval.html",
		"emailSubjectLine": "Letter of Recommendation Request",
		"emailSendBlockers": ["promotion_section"],
