...
tc2_assist_dean_approval = {
	"code": "tc2_assist_dean_approval",
	...
	"blockers": ["approveOFA"],
	"statusMsg": "",
	"successMsgApprove":"Assistant Dean Track Change Approved",
	"successMsgDeny":"Assistant Dean Track Change Denied",
	"successMsgRevisions":"Assistant Dean Track Change Revisions Required",
	"className": "Approval",
	"config": {
		"approve": True,
