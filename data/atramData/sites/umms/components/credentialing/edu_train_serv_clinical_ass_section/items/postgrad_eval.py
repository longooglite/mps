...
postgrad_eval = {
	"code": "postgrad_eval",
	"comment":"",
	"descr": "Manage Post Graduate Training Evaluations",
	"header": "Manage Post Graduate Training Evaluations",
	"componentType": "Task",
	"affordanceType":"Item",
	"optional": False,
	"enabled": True,
	...
	"config": {
		"assessment_header":"Post Graduate Training Evaluations",
		"headerImageOverride":"cred_default_head.png",
		"omitCodes": [],
		"printHeader": "Post Graduate Training Evaluation",
		...
		"emailTemplateName": "umms_cred_postgrad_solicit.html",
		"emailSubjectLine": "Evaluation Request",
		"emailSendBlockers": [],

		"reviewPermissions": ['dept_task','mss_task'],

		"packet_code": "postgrad_packet",
		"omitTOC":True,
