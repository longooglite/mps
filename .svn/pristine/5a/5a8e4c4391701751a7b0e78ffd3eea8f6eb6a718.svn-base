...
req_participate = {
	"code": "req_participate",
	"comment":"",
	"descr": '''Request Participation''',
	"header": '''Request Participation''',
	"componentType": "Task",
	"affordanceType":"Item",
	"optional": False,
	"enabled": True,
	...
	"containers": [],
	"statusMsg": "",
	"successMsg":"Request Participation Complete",
	...
	"config": {
		...
		"emailTemplateName": "engin_umich_promotion_pre_approval.html",
