...
promo_sec_ofa_review_app = {
	"code": "promo_sec_ofa_review_app",
	"comment":"",
	"descr": '''View Promotion Application Casebook''',
	"header": '''View Promotion Application Casebook''',
	"componentType": "Task",
	"affordanceType":"Item",
	"optional": True,
	"enabled": True,
	...
	"containers": [],
	"statusMsg": "",
	"successMsg":"View Promotion Application Casebook Complete",
