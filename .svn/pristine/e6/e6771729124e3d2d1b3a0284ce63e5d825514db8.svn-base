...
promo_regent_approval = {
	"code": "promo_regent_approval",
	"comment":"",
	...
	"config": {
		"activityLog": {
			"enabled": True,
			"activityLogText": "Regents Approval",
			"comments": [
				{
					"commentCode": "promoRegentApprovalComment",
		...
		"approveText": "Approve",
		"approveStatusMsg": "Approved by Regents",
		"approveFreeze": {
